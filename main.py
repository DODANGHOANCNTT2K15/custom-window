...
from mute_status import update_mute_icon, update_mic_mute_icon
...
if __name__ == "__main__":
    ...
    try:
        ...
        root, hwnd, label, battery_icon_label, battery_label, mute_icon_label, mic_mute_icon_label = create_main_window()
