...
def update_mute_icon(root, mute_icon_label):
    def loop():
        ...
        root.after(500, lambda: update_mute_icon(root, mute_icon_label))
    loop()
...
def update_mic_mute_icon(root, mic_mute_icon_label):
    def loop():
        ...
        root.after(500, lambda: update_mic_mute_icon(root, mic_mute_icon_label))
    loop()
...
def update_bluetooth_icon(root, bluetooth_icon_label):
    def loop():
        ...
        root.after(500, lambda: update_bluetooth_icon(root, bluetooth_icon_label))
    loop()